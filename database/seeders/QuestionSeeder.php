...
class QuestionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $AdminQuestion1 = [
        'Encourages the faculty in setting organizational goals and objectives',
        'Provides the faculty with sufficient training to carry out their responsibilities well',
        'Delegates responsibility effectively for greater results',
        'Integrates planning activities at all levels',
        'Shares as much information as possible with the faculty',
        'Provides a collaborative environment that stresses a spirit of involvement',
        'Shows confidence in the faculty to perform important tasks',
        'Provides an environment of spirit of shared ownership',
        'Allows the faculty to design a solution to their problem',
        'Recognizes the success of the faculty by sharing in their joys',
        'Makes the faculty feel that learning is necessary in achieving competence',
        'Takes action only after sufficient planning and consultation',
        'Involves and informs individuals or groups of the criterion or revision of a policy or procedure affecting them'
        ];
        ...
        foreach ($teacherQuestions as $teacherDescription) {
            Question::create([
                'type' => 'EVALUATION OF TEACHERS PERFORMANCE',
                'question_group' => 'N/a',
        ...
        foreach ($AdminQuestion1 as $adminDescription1) {
            Question::create([
                ...
                'question_group' => '2',
                'evaluation_type' => 'Empowerment Skill',
